...
workDir <- "/Users/mnr006/RNASeqProject/SARTools.DESeq2.copy.genes"      # working directory for the R session

projectName <- "SARTools.DESeq2.genese.batch"                         # name of the project
