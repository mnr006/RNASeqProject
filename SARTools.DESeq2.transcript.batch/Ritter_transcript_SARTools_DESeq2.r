...
workDir <- "/Users/mnr006/RNASeqProject/SARTools.DESeq2.transcript.batch"      # working directory for the R session

projectName <- "SARTools.DESeq2.transcript"                         # name of the project
author <- "Megan Ritter"                                # author of the statistical analysis/report
